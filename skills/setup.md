...
| 前缀 | 适用于 | 示例 |
|------|-------|------|
| `痛点-` | 用户问题、不满 | `痛点-性能问题.md`、`痛点-支付流程繁琐.md` |
| `行为-` | 用户行为模式 | `行为-社交驱动流失.md`、`行为-付费决策.md` |
| `需求-` | 用户需求、期望 | `需求-跨平台联机.md`、`需求-自定义皮肤.md` |
| `模式-` | 设计模式、业务模式 | `模式-订阅制变现.md` |
| `趋势-` | 行业/数据趋势 | `趋势-手游市场增长.md` |

**sources/**（资料摘要）：

| 前缀 | 适用于 | 示例 |
|------|-------|------|
| `问卷-` | 问卷调研 | `问卷-12月满意度调研.md`、`问卷-春节满意度.md` |
| `访谈-` | 用户/专家访谈 | `访谈-回流玩家.md`、`访谈-女性玩家.md` |
| `竞品-` | 竞品分析资料 | `竞品-玩家竞品游玩情况.md` |
| `报告-` | 研究报告、数据报告 | `报告-开发者生态.md` |
| `文章-` | 文章、论文 | `文章-游戏机制分析.md` |
| `反馈-` | 用户反馈、评论汇总 | `反馈-基岩互通版首日.md` |

**entities/**（实体页面）：

| 前缀 | 适用于 | 示例 |
|------|-------|------|
| `用户-` | 用户群体/画像 | `用户-女性玩家.md`、`用户-流失玩家.md` |
| `产品-` | 产品/功能 | `产品-G79.md`、`产品-基岩版.md` |
| `组织-` | 公司/团队/社区 | `组织-竞品公司A.md` |
| `服务器-` | 游戏服务器 | `服务器-山头服.md` |

**synthesis/**（综合分析）：

| 前缀 | 适用于 | 示例 |
|------|-------|------|
| `对比-` | 多方对比分析 | `对比-基岩与Java版.md` |
| `洞察-` | 跨源综合洞察 | `洞察-付费转化障碍.md` |
| `概览-` | 某主题全景概述 | `概览-竞品格局.md` |
| `趋势-` | 时间线趋势总结 | `趋势-满意度变化.md` |

**规则**：
1. **每个页面必须带类型前缀**，格式为 `{前缀}-{描述}.md`
2. 前缀使用上表标准前缀，如遇新类型可在 Schema.md 中扩展
3. 描述部分简洁（2-8 个字），代表页面核心主题
4. 纯中文，不附加英文 slug
5. 避免特殊字符（`/ \ : * ? " < > |`），确保跨平台兼容
...
### 步骤 12：预下载 AI 搜索模型（向量语义搜索 + LLM 重排序）
